...
import com.depakto.classes.help.api.CodecEncryptionMode;
import com.depakto.classes.help.api.HostBannerMode;
import com.depakto.classes.help.api.HostMessageMode;
...
public class VirtualServerInfo extends Wrapper {
    ...
    public long getBandwidthReceivedLastMinute() {
        return (long) getInt(VirtualServerProperty.CONNECTION_BANDWIDTH_RECEIVED_LAST_MINUTE_TOTAL);
    }
    ...
    public long getComplainAutobanTime() {
    ...
    public VirtualServerStatus getServerStatus() {
        for (VirtualServerStatus s : VirtualServerStatus.values()) {
            if (s.getName().equals(get(VirtualServerProperty.VIRTUALSERVER_STATUS))) {
                return s;
            }
        }
