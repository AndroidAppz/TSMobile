...
public class TSApiAdmin {
    private final TSQueryAdmin query;

    public TSApiAdmin(TSQueryAdmin query) {
        this.query = query;
    }
    ...
    public void registerAllEvents() {
        registerEvent(TSEventType.CHANNEL);
    }

    public boolean registerEvent(TSEventType t) {
        return registerEvent(t, -1);
    }

    public boolean registerEvent(TSEventType t, int channelId) {
