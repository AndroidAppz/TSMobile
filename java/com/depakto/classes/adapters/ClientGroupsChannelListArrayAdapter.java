...
public class ClientGroupsChannelListArrayAdapter extends ArrayAdapter<String> {
    public final Context context;
    public final List<ChannelGroup> pcs;

    public ClientGroupsChannelListArrayAdapter(Context context, List komp) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String tytul = "(" + ((ChannelGroup) this.pcs.get(position)).getGroupId() + ") " + ((ChannelGroup) this.pcs.get(position)).getName();
